...
@section('title')
    {{trans('page_title.create product')}}
@endsection
@section('css')
            ...
            <div class="nk-block nk-block-lg">
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        <h4 class="title nk-block-title">{{trans('page_title.create product')}}</h4>
                ...
                <div class="card">
                    <div class="card-inner">
                        <form method="post" action="{{route('admin.products.store')}}" class="form form-validate"
                            ...
                            <div class="row g-gs">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label"
                                               for="fv-full-name">{{trans('products.arabic name')}}</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="name[ar]"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label"
                                               for="fv-full-name">{{trans('products.english name')}}</label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="name[en]"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label"
                                               for="fv-full-name">{{trans('products.categories')}}</label>
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" name="product_category_id">
                                                <option value="0" disabled selected>
                                                    ----- {{trans('products.select category')}} -----
                                                </option>
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}"
                                                            @if(old('product_category_id') == $category->id) selected @endif>{{$category->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    @error('product_category_id')<span
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" multiple="multiple" name="tags[]"
                                                    data-placeholder="Select Multiple options">
                                                <option value="0" disabled>----- {{trans('products.select tags')}}
                                                    -----
                                                </option>
                                                @foreach($tags as $tag)
                                                    <option
                                                        value="{{$tag->id}}" {{in_array($tag->id, old('tags')??[] ) ? 'selected' : null }} >{{$tag->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <label class="form-label"
                                           for="fv-full-name">{{trans('products.description')}}</label>
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="quantity"
                                                   value="{{old('quantity')}}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="price"
                                                   value="{{old('price')}}"
                                                   oninput="this.value=this.value.replace(/[^0-9.]/g,'');" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" name="status">
                                                ...
                                                <option value="1"
                                                        @if(old('status') == 1) selected @endif>{{trans('products.active')}}</option>
                                                <option value="0"
                                                        @if(old('status') == 0) selected @endif>{{trans('products.inactive')}}</option>
                                            </select>
                                ...
                                <div class="col-md-3 pt-5">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" value="1"
                                               @if(old('featured')==1) checked @endif  name="featured"
                                               id="customCheck2">
                                        <label class="custom-control-label"
                                               for="customCheck2">{{trans('products.featured')}}</label>
                                    </div>
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor1"  value="#754c24" name="productColor[]"
                                                    {{in_array('#754c24', old('productColor')??[] ) ? 'checked' : null }}
                                                >
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor2" value="#636363" name="productColor[]"
                                                    {{in_array('#636363', old('productColor')??[] ) ? 'checked' : null }}
                                                >
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor3" value="#ba6ed4" name="productColor[]"
                                                                                                    {{in_array('#ba6ed4', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor4" value="#ff87a3" name="productColor[]"
                                                                                                    {{in_array('#ff87a3', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor5" value="#f2426e" name="productColor[]"
                                                                                                    {{in_array('#f2426e', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor6" value="#323f9e" name="productColor[]"
                                                                                                    {{in_array('#323f9e', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor7" value="#058efc" name="productColor[]"
                                                                                                    {{in_array('#058efc', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor8" value="#fd9722" name="productColor[]"
                                                                                                    {{in_array('#fd9722', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor9" value="#20c997" name="productColor[]"
                                                                                                    {{in_array('#20c997', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor10" value="#816bff" name="productColor[]"
                                                                                                    {{in_array('#816bff', old('productColor')??[] ) ? 'checked' : null }}
                                        ...
                                        <li>
                                            <div class="custom-control color-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="productColor11" value="#ff63a5" name="productColor[]"
                                                                                                    {{in_array('#ff63a5', old('productColor')??[] ) ? 'checked' : null }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select js-select2" multiple="multiple" data-placeholder="Select Multiple options" name="size[]">
                                                <option value="s" {{in_array('s', old('size')??[] ) ? 'selected' : null }}>Small</option>
                                                <option value="m" {{in_array('m', old('size')??[] ) ? 'selected' : null }}>medium</option>
                                                <option value="l" {{in_array('l', old('size')??[] ) ? 'selected' : null }} >larg</option>
                                                <option value="xl" {{in_array('xl', old('size')??[] ) ? 'selected' : null }} >x large</option>
                                                <option value="xxl" {{in_array('xxl', old('size')??[] ) ? 'selected' : null }} >xx large</option>
                                                <option value="xxxl" {{in_array('xxxl', old('size')??[] ) ? 'selected' : null }} >xxx large</option>
                                                <option value="xxxxl" {{in_array('xxxxl', old('size')??[] ) ? 'selected' : null }} >xxxx large</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="dropzone" id="document-dropzone">
                                        <div class="dz-message" data-dz-message>
                                                ...
                                                <span class="dz-message-text h-150px pb-3"><svg
                                                        ...
                                                        <rect x="40" y="45" width="23" height="19" fill="#e3e7fe"
                                                              stroke="#6576ff" stroke-linecap="round"
                                                              stroke-linejoin="round" stroke-width="2"></rect>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit"
                                                class="btn btn-lg btn-primary">{{trans('page_title.save')}}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
