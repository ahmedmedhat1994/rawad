        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="html/index.html" class="logo-link">
                    <img class="logo-light logo-img" src="{{asset('backend/images/logo.png')}}" srcset="{{asset('backend/images/logo2x.png')}}" alt="logo">
                    <img class="logo-dark logo-img" src="{{asset('backend/images/logo-dark.png')}}" srcset="{{asset('backend/images/logo-dark2x.png')}}" alt="logo-dark">
                </a>
            </div><!-- .nk-header-brand -->
                ...
                <ul class="nk-quick-nav">
                    <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                            <ul class="language-list">
                                ...
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="{{asset('backend/')}}" alt="" class="language-flag">
                            ...
                            <div class="dropdown-body">
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/apps-chats.html">
                                            <div class="chat-media user-avatar">
                                                <img src="{{asset('backend/images/avatar/b-sm.jpg')}}" alt="">
                                            </div>
                                            <div class="chat-info">
                                                <div class="chat-from">
                                        ...
                                        <a class="chat-link" href="html/apps-chats.html">
                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                <div class="user-avatar">
                                                    <img src="{{asset('backend/images/avatar/c-sm.jpg')}}" alt="">
                                                </div>
                                                <div class="user-avatar">
                                                    <span>AB</span>
                                                </div>
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logout_form').submit();"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
