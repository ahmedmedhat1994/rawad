                        ...
                        <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="{{asset('frontend/imgs/theme/flag-fr.png')}}" alt="">Français</a>
                                    </li>
                                    <li><a href="#"><img src="{{asset('frontend/imgs/theme/flag-dt.png')}}" alt="">Deutsch</a>
                                    </li>
                                    <li><a href="#"><img src="{{asset('frontend/imgs/theme/flag-ru.png')}}" alt="">Pусский</a>
                                    </li>
                                </ul>
                            </li>
                            @guest
                            ...
                            @else
                                <li><i class="fi-rs-user"></i><a href="#">{{ auth()->user()->username  }}</a></li>
                                <li><i class="fa-inbox-out"></i><a href="javascript:void(0);"
        ...
        <div class="container">
            <div class="header-wrap">
                ...
                <div class="header-right">
                    ...
                    <div class="header-action-right refresh-cart">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="{{route('frontend.wishlist')}}">
                                    ...
                                    <span
                                        class="pro-count blue">{{\Gloudemans\Shoppingcart\Facades\Cart::instance('wishlist')->count()}}</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{route('frontend.cart')}}">
                                    <img alt="Evara" src="{{asset('frontend/imgs/shopping-bag.svg')}}">
                                    <span
                                        class="pro-count blue">{{\Gloudemans\Shoppingcart\Facades\Cart::instance('default')->count()}}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img
                                                        src="{{asset('frontend/imgs/banner/menu-banner.jpg')}}"
                                                        alt="Evara"></a>
                        ...
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated">
                                <a href="#" class="hover-up mb-sm-4 mb-lg-0"><img class="active"
                                                                                  src="{{asset('frontend/imgs/theme/app-store.jpg')}}"
                                                                                  alt=""></a>
